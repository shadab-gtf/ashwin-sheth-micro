...
export default function Amenities() {
    ...
    return (
        <section id="amenities" className="pb-[50px] md:pb-[100px] bg-[#FEF7F0] text-center">
            <div className="container mx-auto px-6">
                <div className="mb-10 md:mb-16 max-w-3xl mx-auto">
                    <h2 data-direction="bottom" className="reveal-text text-2xl md:text-4xl leading-[36px] md:leading-[60px] font-medium text-[#E37D24] mb-4">
                        Stunning Luxury Prime Residences, <br /> Designed For Life
                    </h2>
                </div>

                <div ref={containerRef} className="grid grid-cols-2 md:grid-cols-4 gap-x-4 md:gap-x-8 gap-y-8 md:gap-y-12 max-w-5xl mx-auto">
