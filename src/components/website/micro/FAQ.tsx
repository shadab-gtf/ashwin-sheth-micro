    ...
    return (
        <section id="faq" className="py-12 md:py-24 bg-white">
            <div className="container mx-auto px-6 max-w-4xl text-center">
                <h2 data-direction="bottom" className="reveal-text text-[24px] md:text-[32px] leading-[36px] md:leading-[50px] font-medium text-[#E37D24] mb-8 md:mb-16">
                    ...
                    {faqs.map((faq, idx) => (
                        <div key={idx} data-direction="bottom" className="reveal-text bg-[#FFFBF7] rounded-lg text-left overflow-hidden">
                            <button
                                ...
                                className="w-full flex items-center justify-between p-4 md:p-6 hover:bg-[#FDF6ED] transition-colors"
                            >
                            ...
                            <div
                                className={`px-4 md:px-6 pt-3 overflow-hidden transition-all duration-300 ease-in-out ${openIndex === idx ? 'max-h-40 pb-6 opacity-100' : 'max-h-0 opacity-0'}`}
                            >
